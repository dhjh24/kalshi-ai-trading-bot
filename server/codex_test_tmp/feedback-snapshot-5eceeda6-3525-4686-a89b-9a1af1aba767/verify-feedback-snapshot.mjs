...
const dbUrl = pathToFileURL(path.join(root, "src/db.ts")).href;
const appUrl = pathToFileURL(path.join(root, "src/app.ts")).href;
const hubUrl = pathToFileURL(path.join(root, "src/services/liveStreamHub.ts")).href;
