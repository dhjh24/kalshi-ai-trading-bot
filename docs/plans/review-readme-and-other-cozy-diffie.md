...
### W8 — Cost & Budget Instrumentation  *(Status: in progress — `codex_client.py` now persists quota snapshots after every successful CLI call as of 2026-04-26; only fully-attributed plan-tier accounting remains)*
- **Follow-ups flagged by Codex after merge:**
...
### W11 — Legacy Cleanup  *(Status: in progress — compatibility hardening landed as of 2026-04-26; 2026-04-26 audit confirmed all four candidates still have live callers, so no further removals were made)*
