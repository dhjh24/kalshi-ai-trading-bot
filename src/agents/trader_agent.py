...
class TraderAgent(BaseAgent):
    ...
    SYSTEM_PROMPT = (
        ...
        "2. EV AFTER FEES -- Kalshi charges roughly 0.07 x P x (1-P) per "
        "   contract for taker entries (~1.75 cents at mid prices). Expected "
        "   value = (team's fair probability x 100) - entry price - fees. Only "
        "   trade when this is clearly positive with margin for error; a 2-3 "
        "   cent gross edge is usually NOT tradable after fees.\n"
